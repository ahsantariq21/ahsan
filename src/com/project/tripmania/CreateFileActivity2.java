...
public class CreateFileActivity2 extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_create_file_activity2);
    	...
    	Thread t = new Thread(new Runnable() 
    	{
    		...
    		public void run() 
    		{
				try 
				{
					...
					ContentResolver cR = CreateFileActivity2.this.getContentResolver();
